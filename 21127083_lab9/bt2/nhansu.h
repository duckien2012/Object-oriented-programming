...
public:
	...
	void addNhanSu(vector<nhanSu*>&,string);
	void printNhanSu(vector<nhanSu*>);
	void deleteNhanSu(vector<nhanSu*>& ,string);
	double tongLuongNhanSu(vector<nhanSu*>);
	double luongCaoNhat(vector<nhanSu*>);
